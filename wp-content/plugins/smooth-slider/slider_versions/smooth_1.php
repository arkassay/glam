  ...
  // Sliders page only
	...
	?>
        ...
        jQuery(document).ready(function() {
                    ...
                    jQuery("#sslider_sortable_").sortable();
                    jQuery("#sslider_sortable_").disableSelection();
...
function smooth_get_inline_css($echo='0'){
	...
	//smooth_slideri
		$smooth_slider_css['smooth_slideri']=$style_start.'width:'. ( ($smooth_slider['prev_next'] == 1) ? ( $smooth_slider['width'] - 48 ): $smooth_slider['width'] ) .'px;margin:24px '. ( ($smooth_slider['prev_next'] == 1) ? "24": "0" ) .'px'. ( ($smooth_slider['prev_next'] == 1) ? "24": "0" ) .'px;'.$style_end;
