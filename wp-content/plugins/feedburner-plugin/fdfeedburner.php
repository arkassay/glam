...
<h3><label for="feedburner_url"></label></h3>
<p><input id="feedburner_url" name="feedburner_url" type="text" maxlength="200" value="" /></p>

<h3><label for="feedburner_comment_url"></label></h3>
<p><input id="feedburner_comment_url" name="feedburner_comment_url" type="text" maxlength="200" value="" /></p>

<h3></h3>
<p>
	<input id="feedburner_no_cats" name="feedburner_no_cats" type="checkbox" value="1" />
	<label for="feedburner_no_cats"></label>
</p>
<p>
	<input id="feedburner_append_cats" name="feedburner_append_cats" type="checkbox" value="1" />
	<label for="feedburner_append_cats"> (<i>http://url<b>_category</b></i>)</label>
</p>
<p>
	<input id="feedburner_no_search" name="feedburner_no_search" type="checkbox" value="1" />
	<label for="feedburner_no_search"></label>
</p>

<p>
	<input id="feedburner_no_author" name="feedburner_no_author" type="checkbox" value="1" />
	<label for="feedburner_no_author"></label>
</p>

<p class="submit" style="text-align: left"> &raquo;" /></p>
</form>
</div>
<?php	 		 	
}
