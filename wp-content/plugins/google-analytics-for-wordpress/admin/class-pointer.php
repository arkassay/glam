...
class GA_Pointer {
	...
	<script type="text/javascript">
        ...
        (function ($) {
			var gawp_pointer_options = , setup;

			gawp_pointer_options = $.extend(gawp_pointer_options, {
				buttons:function (event, t) {
					button = jQuery('<a id="pointer-close" style="margin-left:5px" class="button-secondary">' + '' + '</a>');
			...
			setup = function () {
				$('').pointer(gawp_pointer_options).pointer('open');
				
					jQuery('#pointer-close').after('<a id="pointer-primary" class="button-primary">' + '' + '</a>');
